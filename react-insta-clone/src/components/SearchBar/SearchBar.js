    ...
    return (
        <div className="searchBar">
            ...
            <div className="searchBarIcons">
                <img className="compass" src="./icons8-compass-32.png" alt="compass logo"></img>
                <img className="heart" src="./icons8-heart-32.png" alt="heart logo"></img>
                <img className="profile" src="./icons8-customer-32.png" alt="profile logo"></img>
            </div>
        </div>
    )
}
